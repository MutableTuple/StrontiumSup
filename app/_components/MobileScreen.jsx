    ...
    >
      ...
      >
        <div className="flex gap-4">
          <motion.img
            className="h-20 w-20 rounded-full outline outline-4 outline-offset-4 outline-stone-800 object-cover"
          ...
          >
            <h1 className="font-bold text-md flex gap-2 items-center">
        ...
        >
          <div className="text-center">
            <h1 className="font-bold text-lg">100,906</h1>
            <p className="text-sm">Followers</p>
          </div>
          <div className="text-center">
            <h1 className="font-bold text-lg">3,147</h1>
