...
export default function MobileScreen() {
  return (
    <motion.div
      className="h-[640px] md:mt-24 mt-0  w-96  rounded-t-md overflow-scroll outline-stone-100 border-2 shadow-ext p-2 mobile-frame md:w-[390px] w-[352px] no-scrollbar"
